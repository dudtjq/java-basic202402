...
//        }
    ...
    public static void main(String[] args) {
        ...
        //파스타의 인덱스 알아내기
        int result = indexOf("파스타");
        System.out.println("파스타의 인덱스는 : " + result);
        
        //김치찌개의 인덱스 알아내기
        int result2 = indexOf("김치찌개");
        System.out.println("김치찌개의 인덱스는 : " + result2);

        //짜장면의 인덱스 알아내기(존재하지 않는 값)
        int result3 = indexOf("짜장면");
        System.out.println("짜장면의 인덱스는 : " + result3);
