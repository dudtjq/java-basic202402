...
public class BreadMain {
    ...
    public static void main(String[] args) {
        ...
        Bread breadInfo = new Bread();
        breadInfo.showBread();

        System.out.println("---------------------------------");

        Bread newBreadInfo = new Bread("에그타르트", 3500 , "계란");
        newBreadInfo.showBread();

        System.out.println("---------------------------------");

        Bread newBreadInfo2 = new Bread("플레인스콘", 3200 , "밀가루");
        newBreadInfo2.showBread();
