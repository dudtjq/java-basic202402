...
public class StringMethod {
    ...
    public static void main(String[] args) {
        ...
        // charAt(index) : 문자열 인덱스에 따른 단일 문자르 반환
        char c = str.charAt(4);
        ...
        //length() : 문자열의 총 길이 반환
        int len = str.length();
        System.out.println("len = " + len);// 공백까지 포함 하여 총 길이를 알려줌
        
        // indexOf(str) : 해당 문자가 있는 인덱스를 반환
        // 해당 문자가 존재하지 않는다면 -1 를 리턴
        ...
        // 여러 문자를 전달 하면 시작 인덱스를 알려준다
        int idx3 = str.indexOf("Java");
        System.out.println("idx3 = " + idx3);

        String str2 = "HeLLo WoRLd";

        String lower = str2.toLowerCase(); // 소문자를 변경
        System.out.println("lower = " + lower);

        String upper = str2.toUpperCase(); // 대문자를 변경
        ...
        double v = Double.parseDouble(s2); // 문자열 -> 실수
        System.out.println(i + v);

        // valueOf : 기본타입을 문자열로 변경
        System.out.println(String.valueOf(i) + String.valueOf(v));
