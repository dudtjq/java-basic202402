...
//            System.out.println(ArtistRepository.getArtistList());
    ...
    // 2번 메뉴에 대한 입출력 실행 내용
    private static void searhProcess() {
    ...
    // 1번 메뉴에 대한 입출력 실행 내용
    private static void insetProcess() {
        ...
        // 기존에 등록된 가수인가?
        // 그렇다면 -> 새로운 가수 생성하는 것이 아닌, 기존 가수 정보에서 노래만 추가
